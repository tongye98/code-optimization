...
def parse_args():
    ...
    parser.add_argument("--model_checkpoint",type=str,default="/largespace/tydata/models-hf/CodeLlama-7b-hf")
...
def prepare_input1(data):
    ...
    input = f"Tell me effective strategies to improve the time efficiency of a given code in natural language.\n{prompt}\n{slow_code}\n Strategies:"
